...
class EulerRepresentation(AbstractRepresentation):
    ...
    def update_feature_volume(self, feature, index, xyz, roll, pitch_index, pitch_residual, yaw_index, yaw_residual):
        ...
        feature[index, pitch_index, yaw_index, 4] = roll # 4, 5
        feature[index, pitch_index, yaw_index, 5] = pitch_residual
        feature[index, pitch_index, yaw_index, 6] = yaw_residual
...
def retrive_from_feature_volume(pts, feature, M, n_pitch, n_yaw, hand_height, gripper_width, thickness_side, rot_th, trans_th, n_output=10, threshold=0.0, nms=False):
    ...
    for ind in index:
        ...
        roll = float(feature[pt_idx, pitch_idx, yaw_idx, 4])
        pitch_residual = feature[pt_idx, pitch_idx, yaw_idx, 5]
        yaw_residual = feature[pt_idx, pitch_idx, yaw_idx, 6]
