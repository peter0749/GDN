...
def loss_baseline(y_pred, y_true, cls_w, x_w, y_w, z_w, rot_w, **kwargs):
    ...
    if accum_gt.any():
        ...
        y_p             = y_pred_masked[...,2]
        z_p             = y_pred_masked[...,3]
        roll_p            = y_pred_masked[...,4]
        pitch_residual_p  = y_pred_masked[...,5] # 0~1
        yaw_residual_p    = y_pred_masked[...,6] # 0~1

        x_gt            = y_true_masked[...,1]
        y_gt            = y_true_masked[...,2]
        z_gt            = y_true_masked[...,3]
        roll_gt           = y_true_masked[...,4]
        pitch_residual_gt = y_true_masked[...,5] # 0~1
