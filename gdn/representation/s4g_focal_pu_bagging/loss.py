...
def loss_baseline(y_pred, y_true, y_neg_mask, cls_w, rot_w, trans_w, **kwargs):
...
class MultiTaskLossWrapper(nn.Module):
    ...
    def forward(self, outputs, targets, bootstrap_mask):
        ...
        (loss, cls_loss, rot_loss, trans_loss) = loss_baseline(outputs, targets, bootstrap_mask, ws[0], ws[1], ws[2])
