...
if __name__ == '__main__':
    ...
    for e in range(start_epoch,1+epochs):
        ...
        for _ in range(len(dataloader)):
            ...
            l21 = l21.mean()
            # forward(self, point_cloud, outputs, ind, importance, targets):
            (loss, foreground_loss, cls_loss,
                iou_loss, ws, uncert) = loss_function(pc, pred, ind, att, volume)
        ...
        logger.add_scalar('train/iou_loss', iou_loss_epoch, e)
        ...
        logger.add_scalar('loss_weights/iou', ws[2], e)
        ...
        if e % config['eval_freq'] == 0:
            ...
            with torch.no_grad():
                ...
                logger.add_scalar('eval/iou_loss', iou_loss_epoch, e)
